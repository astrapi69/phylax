 ...
 * caller stores `needRefresh=true` in `UpdateContext` and the
 * Header's `<UpdateIndicator>` renders a compact pill that the user
 * clicks to apply the update. The returned function calls
