 ...
 *
 * Uses PBKDF2 with SHA-256 and 600,000 iterations. The resulting key
 * is non-extractable and usable only for encrypt/decrypt.
 *
 * Security: both the intermediate PBKDF2 base key and the final AES key
 * are created with extractable=false. There is no legitimate use case
 * for exporting key material once derived.
 *
