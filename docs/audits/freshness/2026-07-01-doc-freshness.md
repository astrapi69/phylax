...
| `README.md` features list | B - missing coverage | P2       | Multi-Profile support (M-01..M-05): profile switcher route, ActiveProfileContext, per-profile export filter, in-app create-with-cancel, caregiver badge - none appear in the features list. The "Who is Befaro for" section mentions caregiver use but the features list does not reflect the shipped functionality. | Add a Multi-Profile / Profile Switcher bullet to the features list.                                                |
