...
- [ ] **O-12** Lab value form: date, parameter, result, reference range, assessment
  ...
  - [ ] **O-12b** LabValue manual CRUD: per-card "Wert hinzufügen", per-row edit/delete, datalist suggestions (parameter via new `LabValueRepository.listParameters`, assessment from a fixed suggestion set), category re-assignment in edit mode (Q3)
